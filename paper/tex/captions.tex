...
size it is \FragileGivenSigNEighteen{}. The same bound grid gives
\FragileGivenSigNTwoHundred{} at \(n=\SimNTwoHundred{}\) and
\FragileGivenSigNFiveHundred{} at \(n=\SimNFiveHundred{}\). Both fall as \(n\) grows. The distances
