...
measurement. The panel built from the fixed measurement table is bound and
re-hashed on every build, yet no figure reads it because its status places it
outside the registered analysis. Binding an artifact the analysis deliberately
...
record, and blocked-tier handling --- are enforced by build-time checks that
